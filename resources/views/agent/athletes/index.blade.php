                    ...
                    <table id="dataTableExample" class="table table-hover">
                        <thead>
                            ...
                            @if (session()->has('error'))
                                <div id="errorMessage" class="alert alert-danger text-center my-2">{{ session()->get('error') }}</div>
                            @endif
                        ...
                        <tbody>
                            @foreach ($athletes as $athlete)
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        <button class="btn text-info-success read-athlete" data-bs-toggle="modal" data-bs-target="#readData" data-id="{{ $athlete->id }}" data-nom="{{ $athlete->nom }}" data-prenom="{{ $athlete->prenom }}" data-date_naissance="{{ $athlete->date_naissance }}" data-groupeage="{{ $athlete->groupage }}" data-adress="{{ $athlete->adress }}" data-email="{{ $athlete->email }}" data-club="{{ auth()->user()->name }}" data-photo="{{ asset($athlete->photo) }}">
                                            <i class="bi bi-eye"></i>
                                        </button>
