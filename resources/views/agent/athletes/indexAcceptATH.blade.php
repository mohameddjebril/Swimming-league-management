                    ...
                    <table id="dataTableExample" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <button class="btn text-info-success read-athlete" data-bs-toggle="modal" data-bs-target="#readData" data-id="{{ $athlete->id }}" data-nom="{{ $athlete->nom }}" data-prenom="{{ $athlete->prenom }}" data-date_naissance="{{ $athlete->date_naissance }}" data-groupeage="{{ $athlete->groupeage }}" data-adress="{{ $athlete->adress }}" data-email="{{ $athlete->email }}" data-club="@foreach ($athlete->users as $user) {{ $user->name }} @endforeach" data-photo="{{ asset($athlete->photo) }}">
                                        <i class="bi bi-eye"></i>
                                    </button>
