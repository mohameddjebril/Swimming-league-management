          ...
          <div class="d-none d-md-block col-md-5 col-xl-5 left-wrapper">
            <div class="card rounded">
              ...
              <div class="d-flex align-items-center justify-content-between mb-2">
                        <div>
                            <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/agent_img/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
            ...
            <div class="row">
              ...
              <div class="card-body">
								...
								<form method="POST" action="{{ route('agent.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/agent_img/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
									</div>
