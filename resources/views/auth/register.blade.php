                                    ...
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputUsername1" name="username" autocomplete="username" placeholder="Username">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="address" class="form-control" id="exampleInputEmail1" name="address" placeholder="Address">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="exampleFormControlSelect1" name="status" placeholder="Status">
