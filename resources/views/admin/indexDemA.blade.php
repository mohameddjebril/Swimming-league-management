...
<tr style="text-align: center;">
    ...
    <tr style="text-align: center;">
        ...
        <td>
            {{-- <a class="btn text-info" href="{{ url('Accept_athletes', $athlete->id) }}"><i class="bi bi-pencil-square"></i></a>
            <a class="btn text-info" href="{{ url('Reject_athletes', $athlete->id) }}"><i class="bi bi-pencil-square"></i></a> --}}
            <a class="btn text-info" href="{{ url('/admin/Accept_athletes', $athlete->id) }}">
                <i class="bi bi-check-circle"></i> 
            </a>

            <a class="btn text-danger" href="{{ url('/admin/Reject_athletes', $athlete->id) }}">
